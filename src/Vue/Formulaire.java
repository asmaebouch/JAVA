...
public class Formulaire extends JFrame {
    ...
    private JLabel lbl_title, lbl_login,lbl_id, lbl_prenom,lbl_nom,lbl_confirmation,lbl_email,lbl_telephone,lblidAgence,lbl_pass;

    private JButton btn_Effacer;
    private JButton btn_Cancel;
    private JButton btn_Ajouter;
    private JTextField txt_login,txt_id,txt_prenom,txt_nom,txt_email,txt_telephone,txt_idagenece;
    ...
    private void initLabel() {
        ...
        lbl_id.add(Box.createVerticalStrut(10));
        //personnalisation de label titre
        lbl_id.setFont((new Font("optima", Font.BOLD, 20)));
    ...
    private void initTextFields() {
        ...
        txt_telephone = new JPasswordField("");
        //////////////PASSWORD///////////////////////////////
        //personnalisation de label titre
        txt_telephone.setFont((new Font("optima", Font.BOLD, 10)));
        txt_telephone.setForeground(new Color(105, 59, 105, 255));
        txt_telephone.setHorizontalAlignment(JPasswordField.CENTER);
        txt_idagenece = new JPasswordField("");
        //////////////PASSWORD///////////////////////////////
        //personnalisation de label titre
        txt_idagenece.setFont((new Font("optima", Font.BOLD, 10)));
        txt_idagenece.setForeground(new Color(105, 59, 105, 255));
        txt_idagenece.setHorizontalAlignment(JPasswordField.CENTER);
        ////////////
        txt_id = new JPasswordField("");
        //////////////PASSWORD///////////////////////////////
        //personnalisation de label titre
        txt_id.setFont((new Font("optima", Font.BOLD, 10)));
        txt_id.setForeground(new Color(105, 59, 105, 255));
        txt_id.setHorizontalAlignment(JPasswordField.CENTER);
    ...
    private void initPanels() {
        ...
        centerPanel.setLayout(new GridLayout(10, 4, 10, 8));
