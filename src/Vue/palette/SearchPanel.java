...
public class SearchPanel extends JPanel {
    ...
    //fparametre ndire dynamique
    private void initLabel(){
        lbl_search =new JLabel(new ImageIcon(cl.getResource("images/icons/search.png")));
...
public SearchPanel(){
        ...
        initTextField();
   setLayout(new FlowLayout((FlowLayout.RIGHT))); //pour un seule element 5edame liya
add(txt_search);
}
/*package vue.palette;
